            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="" style=" margin-top: 2%;">
                        <header id="head1">
                            <img src="assets/img/Icon2.png" class="rounded float-left" style="width: 15%;"
                                alt="Image">
                        ...
                        <section>
                            ...
                            <article>
                                <table class="table">
                                    ...
                                    <tbody>
                                        @for ($i = 0; $i < count($prescriptionContents); $i++)
                                            <tr>
                                                <th scope="row">{{ $i + 1 }}</th>
                                                <td> {{ $prescriptionContents[$i]->medicine }} </td>
                                                <td> {{ $prescriptionContents[$i]->times }} </td>
                                                <td> {{ $prescriptionContents[$i]->days }} </td>
                                                <td> {{ $prescriptionContents[$i]->suggession }} </td>
                                            </tr>
                                        @endfor
                                    </tbody>
                                </table>
