                                        ...
                                        <tbody>
                                            @if (count($doctorList) == 0)
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td><strong>No Registered Doctors</strong></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td></td>
                                                </tr>
                                            @else
                                                @foreach ($doctorList as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->contact }}</td>
                                                        <td>{{ $item->email }}</td>
                                                        <td>{{ $item->bmdcRegNum }}</td>
                                                        <td>{{ $item->nidPassport }}</td>
                                                        <td>{{ $item->department }}</td>
                                                        <td><a style="color: white"
                                                            href="{{route('deleteDoctor', [$item->email, $item->contact, $item->bmdcRegNum, $item->nidPassport, $item->department])}}"-
