                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="img-profile rounded-circle" src="/userImage/patient.png"
                                        ...
                                        <tbody>
                                            @foreach ($prescriptionHistory as $item)
                                                <tr>
                                                    ...
                                                    <td><input type="submit" style="color: white" value="Not available yet" class="btn btn-sm btn-info" disabled></td>
                                                </tr>
                                            @endforeach
