            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            @if (!$createPatient)
                                <a style="color: white" href="{{ route('loadCreatePatient') }}"
                                    class="pLoader abc btn btn-sm btn-success px-4 mb-3 ml-3">Create Patient From
                                    Appointment</a>
                                <div class="card mb-4">
                                    <div
                                        class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">Appointments pending for approval
                                        </h6>
                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if ($item->status == 'Applied')
                                                                    <div class="row">
                                                                        <form
                                                                            action="{{ route('handleAppointment') }}"
                                                                            method="post">
                                                                            @csrf
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if ($item->status == 'Confirm')
                                                                    <div class="pl-2 row">
                                                                        <form
                                                                            action="{{ route('createPatientAppointment') }}"
                                                                            method="post">
                                                                            @csrf
                                                                            <input type="hidden" name="id"
                                                                                value="{{ $item->id }}">
