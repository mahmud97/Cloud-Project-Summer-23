...
<head>
    ...
    <title>Doctor - Patients Appointments</title>
                                                                        ...
                                                                        @else
                                                                            @if ($item->status == 'Miss')
                                                                                <label
                                                                                    ...
                                                                                    class="badge">Missed</label>
                                                                            @endif
                                                                            @if ($item->status == 'Accept')
                                                                                <label
                                                                                    style="background-color: rgb(36, 218, 0); color:white"
                                                                                    class="badge">Accepted</label>
                                                                            @endif
                                                                            @if ($item->status == 'Confirm')
                                                                                <label
                                                                                    style="background-color: rgb(94, 76, 255); color:white"
                                                                                    class="badge">Confirmed</label>
                                                                            @endif
                                                                        @endif
                                                                    </td>
                                                                            ...
                                                                            <div style="display: flex">
                                                                                ...
                                                                                <form action="{{ route('status') }}"
                                                                                    ...
                                                                                    <input type="hidden"
                                                                                        ...
                                                                                        value="{{ $item->id }}">
                                                                                    <input type="hidden"
                                                                                        name="type" value="Miss">
                                                                                    <input type="submit"
                                                                                        style="color: white"
                                                                                        value="Missed" id="reject"
                                                                                        class="btn btn-danger btn-sm">
                                                                                </form>
                                                                            </div>
                                                                        @endif
